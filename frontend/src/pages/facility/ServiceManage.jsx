        ...
        <div>
            ...
            <div className='flex items-center justify-between' style={{ padding: '1rem 1.5rem'}}>
                <div className='flex gap-2 items-center'>
                    ...
                    <p className='text-gray-500'><span className='font-bold text-xl text-black'>{rowCount}</span> Dịch vụ</p>
                </div>
                <Stack direction={"row"} spacing={2}>
                    <Button color='warning' variant='outlined' startIcon={<FilterListIcon />}>
                        Lọc
                    </Button>
                    <Button variant='contained' startIcon={<AddIcon />} sx={{ boxShadow: 'none' }} component={Link} to="/facility/services/new">
                        Thêm dịch vụ
                    </Button>
                </Stack>
            </div>
            ...
            <div style={{ padding: '1rem 1.5rem' }}>
                <TreatmentDataGrid setDataCount={setRowCount}/>
            </div>
        </div>
    );
}
